#!/usr/bin/env python3
"""Run ONE problem of castle through TrustedRouter and emit a reproducibility bundle.
...
def main() -> int:
    ap = argparse.ArgumentParser(description="Run one castle problem via TrustedRouter")
